...
**[ToDo-list]** is a ToDo list with pending task with a minimalistic style using.
...
- [ToDo-list](https://victormc13.github.io/ToDo-list/)
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/ToDo-list.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/ToDo-list/issues).
